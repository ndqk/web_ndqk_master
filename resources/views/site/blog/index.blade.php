        ...
        <div class="row">
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog1.jpg')}}" alt="">
                    <!-- Post Title -->
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog2.jpg')}}" alt="">
                    <!-- Post Title -->
                    <div class="post-title">
                        <a href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog3.jpg')}}" alt="">
                    <!-- Post Title -->
                    <div class="post-title">
                        <a href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog4.jpg')}}" alt="">
                    <!-- Post Title -->
                    <div class="post-title">
                        <a href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog5.jpg')}}" alt="">
                    <!-- Post Title -->
                    <div class="post-title">
                        <a href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
            ...
            <div class="col-12 col-lg-6">
                <div class="single-blog-area mb-50">
                    <img src="{{asset('site/img/bg-img/blog6.jpg')}}" alt="">
                    <!-- Post Title -->
                    <div class="post-title">
                        <a href="#">Vivamus sed nunc in arcu cursus mollis quis et orci. Interdum et malesuada</a>
                    </div>
