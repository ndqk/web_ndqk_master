...
@section('titleHeader', 'Create To to list')
@section('nameRoute', 'To-do-list / Create')
...
<div class="card card-primary">
    ...
    <!-- /.card-header -->
    <!-- form start -->
    <form id="create-post-form" role="form" method="post" action="{{route('todo-list.store')}}" enctype="multipart/form-data">
      @csrf
      <div class="card-body">
