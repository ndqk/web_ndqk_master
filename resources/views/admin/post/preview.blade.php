        ...
        <article class="row entry format-standard">
            ...
            <div class="entry__media col-full">
                <div class="entry__post-thumb">
                    <img src="{{asset('site/images/thumbs/single/standard/standard-1000.jpg')}}" 
            ...
            <div class="entry__header col-full">
                ...
                <ul class="entry__header-meta">
                    ...
                    <li class="byline">
                        By
                        <a href="{{asset('site/#0')}}">Jonathan Doe</a>
                    </li>
                </ul>
            </div>
            ...
            <div class="col-full entry__main">
                ...
                <p>
                <img src="{{asset('site/images/wheel-1000.jpg')}}" srcset="{{asset('site/images/wheel-2000.jpg 2000w, images/wheel-1000.jpg 1000w, images/wheel-500.jpg 500w')}}" sizes="(max-width: 2000px) 100vw, 2000px" alt="">
                </p>

                <h2>Large Heading</h2>

                <p>Harum quidem rerum facilis est et expedita distinctio. Nam libero tempore, cum soluta nobis est eligendi optio cumque nihil impedit quo minus <a href="{{asset('site/http://#')}}">omnis voluptas assumenda est</a> id quod maxime placeat facere possimus, omnis dolor repellendus. Temporibus autem quibusdam et aut officiis debitis aut rerum necessitatibus saepe eveniet ut et.</p>
                ...
                <div class="entry__taxonomies">
                    <div class="entry__cat">
                        ...
                        <span class="entry__tax-list">
                            <a href="{{asset('site/#0')}}">Lifestyle</a>
                            <a href="{{asset('site/#0')}}">Management</a>
                        </span>
                    </div> <!-- end entry__cat -->
                    ...
                    <div class="entry__tags">
                        ...
                        <span class="entry__tax-list entry__tax-list--pill">
                            <a href="{{asset('site/#0')}}">orci</a>
                            <a href="{{asset('site/#0')}}">lectus</a>
                            <a href="{{asset('site/#0')}}">varius</a>
                            <a href="{{asset('site/#0')}}">turpis</a>
                        </span>
                    </div> <!-- end entry__tags -->
                </div> <!-- end s-content__taxonomies -->

                <div class="entry__author">
                    <img src="{{asset('site/images/avatars/user-03.jpg')}}" alt="">
